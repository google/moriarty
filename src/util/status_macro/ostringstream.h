...
#ifndef MORIARTY_SRC_UTIL_STATUS_MACRO_OSTRINGSTREAM_H_
#define MORIARTY_SRC_UTIL_STATUS_MACRO_OSTRINGSTREAM_H_
...
#endif  // MORIARTY_SRC_UTIL_STATUS_MACRO_OSTRINGSTREAM_H_
