...
#ifndef MORIARTY_SRC_UTIL_SOURCE_LOCATION_H_
#define MORIARTY_SRC_UTIL_SOURCE_LOCATION_H_
...
class SourceLocation {
 public:
  ...
  // used by the MORIARTY_LOC macro, hence the name.
...
#define MORIARTY_LOC                                                       \
  moriarty::moriarty_status::SourceLocation::DoNotInvokeDirectly(__LINE__, \
                                                                 __FILE__)
#define MORIARTY_LOC_CURRENT_DEFAULT_ARG \
  = moriarty::moriarty_status::SourceLocation::current()

#endif  // MORIARTY_SRC_UTIL_SOURCE_LOCATION_H_
